...
## Soal 1
### Poin (a)
Mengumpulkan informasi jenis log (ERROR/INFO), pesan log, dan username pada setiap baris lognya dari file syslog.log dengan regex. Hasil dimasukkan ke file logTest.txt.
Command:
